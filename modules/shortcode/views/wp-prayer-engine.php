...
if ( ! empty($prayers)) {
    ...
    foreach ($prayers as $pray) {
		...
		$timeago=human_time_diff( strtotime($pray->prayer_time), current_time( 'timestamp', 1 ) );}
		echo $timeago;
                        ...
                        <article id="div-comment-2" class="comment-body">
                            <footer class="comment-meta">
                                <div class="comment-author vcard">
									...
									$timeagoc=human_time_diff( strtotime($cmt->comment_date), current_time( 'timestamp', 1 ) );}
                                    ?>
